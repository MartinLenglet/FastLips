...
def main(args, configs):
    ...
    # Init logger
    os.makedirs(os.path.join(train_config["path"]["ckpt_path"]), exist_ok=True)
    os.makedirs(os.path.join(train_config["path"]["log_path"]), exist_ok=True)
    os.makedirs(os.path.join(train_config["path"]["result_path"]), exist_ok=True)
        ...
        for batchs in loader:
            for batch in batchs:
                ...
                if step % log_step == 0:
                    ...
                    message2 = "Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Duration Loss: {:.4f}, Phon Loss: {:.4f}, Visual Loss: {:.4f}, Visual PostNet Loss: {:.4f}, Lip Aperture Loss: {:.4f}, Lip Spreading Loss: {:.4f}".format(
                        *losses
                    )
