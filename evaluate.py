...
def evaluate(model, step, configs, output_wav, logger=None, vocoder=None, no_spectro=False):
    ...
    message = "Validation Step {}, Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Duration Loss: {:.4f}, Phon Loss: {:.4f}, Visual Loss: {:.4f}, Visual PostNet Loss: {:.4f}, Lip Aperture Loss: {:.4f}, Lip Spreading Loss: {:.4f}".format(
